  ...
  return (
    <div className="mt-12">
      <div className="flex  flex-wrap lg:flex-nowrap justify-center ">
        ...
        lg:w-80 p-8 pt-9 m-3 bg-cover bg-center">
        ...
        {/* this div represents the cards */}
        <div className="flex m-3 flex-wrap justify-center gap-1 items-center">
          {/* dynamic block of code: 
          over the earningData we can get each individual item with .map and 
          we can return a div for each card with a specific key */}
      ...
      <div className="flex gab-10 flex-wrap justify-center">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780">
          <div className="flex justify-between">
            <p className="text-semibold text-xl">Revenue Updates</p>
          ...
          <div className="mt-10 flex gap-10 flex-wrap justify-cnter">
            <div className="border-r-1 border-color m-4 pr-10">
              <div>
                  <p>
                    <span className="text-3xl 
                    text-semibold"> $94,698 
                    </span>
                    <span className="p-1.5 hover:drop-shadow-xl 
                    cursor-pointer rounded-full
                    text-white bg-green-400 ml-3 text-xs"> 23% 
                    </span>
                  </p>
